"""Build the Master and Preview interactive readers for Influence with perfect canonical chapter metadata."""
...
MASTER_HTML_PATH = BOOK_DIR / "Influence_Interactive_Reader_Master.html"
PREVIEW_HTML_PATH = BOOK_DIR / "Influence_Interactive_Reader_Preview.html"

CHAPTER_META = [
    {
        "num": 0,
        "prefix": "influence_ch00",
        "audio": "chapter_00.mp3",
        "menu_tag": "PREFACE",
        "menu_title": "Preface",
        "short_label": "Preface",
        "heading_top": "PREFACE",
    ...
    {
        "num": 1,
        "prefix": "influence_ch01",
        "audio": "chapter_01.mp3",
        "menu_tag": "INTRODUCTION",
        "menu_title": "Introduction",
        "short_label": "Introduction",
        "heading_top": "INTRODUCTION",
        "heading_title": "",
    },
    {
        "num": 2,
        "prefix": "influence_ch02",
        "audio": "chapter_02.mp3",
        "menu_tag": "CHAPTER 1",
        "menu_title": "Levers of Influence",
        "short_label": "Ch. 1 · Levers of Influence",
        "heading_top": "CHAPTER 1",
        "heading_title": "Levers of Influence",
    },
    {
        "num": 3,
        "prefix": "influence_ch03",
        "audio": "chapter_03.mp3",
        "menu_tag": "CHAPTER 2",
        "menu_title": "Reciprocation",
        "short_label": "Ch. 2 · Reciprocation",
        "heading_top": "CHAPTER 2",
        "heading_title": "Reciprocation",
    },
    {
        "num": 4,
        "prefix": "influence_ch04",
        "audio": "chapter_04.mp3",
        "menu_tag": "CHAPTER 3",
        "menu_title": "Liking",
        "short_label": "Ch. 3 · Liking",
        "heading_top": "CHAPTER 3",
        "heading_title": "Liking",
    },
    {
        "num": 5,
        "prefix": "influence_ch05",
        "audio": "chapter_05.mp3",
        "menu_tag": "CHAPTER 4",
        "menu_title": "Social Proof",
        "short_label": "Ch. 4 · Social Proof",
        "heading_top": "CHAPTER 4",
        "heading_title": "Social Proof",
    },
    {
        "num": 6,
        "prefix": "influence_ch06",
        "audio": "chapter_06.mp3",
        "menu_tag": "CHAPTER 5",
        "menu_title": "Authority",
        "short_label": "Ch. 5 · Authority",
        "heading_top": "CHAPTER 5",
        "heading_title": "Authority",
    },
    {
        "num": 7,
        "prefix": "influence_ch07",
        "audio": "chapter_07.mp3",
        "menu_tag": "CHAPTER 6",
        "menu_title": "Scarcity",
        "short_label": "Ch. 6 · Scarcity",
        "heading_top": "CHAPTER 6",
        "heading_title": "Scarcity",
    },
    {
        "num": 8,
        "prefix": "influence_ch08",
        "audio": "chapter_08.mp3",
        "menu_tag": "CHAPTER 7",
        "menu_title": "Commitment and Consistency",
        "short_label": "Ch. 7 · Commitment & Consistency",
        "heading_top": "CHAPTER 7",
        "heading_title": "Commitment and Consistency",
    },
    {
        "num": 9,
        "prefix": "influence_ch09",
        "audio": "chapter_09.mp3",
        "menu_tag": "CHAPTER 8",
        "menu_title": "Unity",
        "short_label": "Ch. 8 · Unity",
        "heading_top": "CHAPTER 8",
        "heading_title": "Unity",
    },
    {
        "num": 10,
        "prefix": "influence_ch10",
        "audio": "chapter_10.mp3",
        "menu_tag": "CHAPTER 9",
        "menu_title": "Instant Influence",
        "short_label": "Ch. 9 · Instant Influence",
        "heading_top": "CHAPTER 9",
        "heading_title": "Instant Influence",
    },
]
...
def main():
    ...
    for meta in CHAPTER_META:
        ...
        if not aligned_path.is_file():
            print(f"Skipping Ch {cnum:02d} (aligned file not found: {aligned_path})")
            continue
        sents = json.loads(aligned_path.read_text(encoding="utf-8"))
        loaded_chapters.append({
            "num": cnum,
            "meta": meta,
            "audio": f"./audio/{meta['audio']}",
            "public_audio": None,
            "sentences": sents,
        })
        chapter_labels_dict[cnum] = meta["short_label"]
    ...
    book_subtitle = "The Psychology of Persuasion (Complete 11 Chapters Edition)"
    book_author = "Robert B. Cialdini"
    first_ch_num = loaded_chapters[0]["num"]
    first_ch_meta = loaded_chapters[0]["meta"]
    book_id = "influence_cialdini_master"
  ...
  <div class="nav-bar">
    <div class="chapter-nav-wrapper">
      <button class="chapter-btn" id="chapterSelectBtn" onclick="toggleChapterDropdown(event)">
        <span>📖 {html.escape(book_title)} · <span id="currentChapterLabel">{html.escape(first_ch_meta['short_label'])}</span></span>
...
"""
    ...
    for ch in loaded_chapters:
        ...
        html_head += f"""        <div class="chapter-item{active_cls}" id="menu-ch-{cnum}" onclick="switchChapter({cnum})">
          <span class="chapter-item-tag">{html.escape(meta['menu_tag'])}</span>
          <span>{html.escape(meta['menu_title'])}</span>
        </div>\n"""
...
"""
    ...
    for ch in loaded_chapters:
        ...
        if meta["heading_title"]:
            title_block = f"{html.escape(meta['heading_top'])}<br>{html.escape(meta['heading_title'])}"
        else:
            title_block = f"{html.escape(meta['heading_top'])}"
  ...
  <section class="chapter-section{active_cls}" id="chapter-{cnum}" data-audio="{html.escape(caudio)}" data-public-audio="{html.escape(cpublic_audio)}" data-ch="{cnum}">
    <header class="book-header">
      ...
      <h1 class="book-title">{title_block}</h1>
...
"""
        for s in csents:
            ...
            if vocab_html_list:
                ...
                vocab_section = f'<div class="inspect-vocab-list">{joined_vocab}</div>'
...
"""
    ...
    first_ch_public_audio_json = json.dumps(None)
    chapter_labels_json = json.dumps(chapter_labels_dict, ensure_ascii=False)
...
window.__INITIAL_PUBLIC_AUDIO__ = {first_ch_public_audio_json};
window.__CHAPTER_LABELS__ = {chapter_labels_json};
...
function switchChapter(chNum) {{
  ...
  const labelText = (window.__CHAPTER_LABELS__ && window.__CHAPTER_LABELS__[chNum]) || ('Ch. ' + chNum);
  currentChapterLabel.textContent = labelText;
...
function startSentenceShadowing(sentenceEl) {{
  ...
  if (activeSection && activeSection.dataset.audio) {{
    const src = resolveAudioSource(activeSection);
...
"""
    ...
    atomic_write_text(str(MASTER_HTML_PATH), html_head + html_tail)
    atomic_write_text(str(PREVIEW_HTML_PATH), html_head + html_tail)
    print(f"Successfully generated Master HTML: {MASTER_HTML_PATH}")
    print(f"Successfully updated Preview HTML: {PREVIEW_HTML_PATH}")
    print(f"Total chapters included: {len(loaded_chapters)}")
    return 0
